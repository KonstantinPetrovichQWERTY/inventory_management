    ...
    <main className="p-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 mt-4">
        <div className="md:w-1/2">
          <img src={product.image} alt={product.title} className="w-full h-96 object-contain rounded-lg border-2 border-neutral-200" />
        </div>
        ...
        <div className="md:w-1/2">
          ...
          <div className="mt-6 flex gap-4">
            <Link href={`/products/edit/${product.id}`} className="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">
              Edit product
            </Link>
